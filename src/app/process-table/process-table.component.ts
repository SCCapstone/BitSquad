...
export class ProcessTableComponent implements OnInit{
  ...
  constructor (private accountService: AccountService, private processService: ProcessService, private userPage: UserPageComponent
      ...
      this.sortedData = this.Process.slice();
  ...
  sortData(sort: Sort) {
    ...
    this.sortedData = data.sort((a, b) => {
      ...
      switch (sort.active) {
        case 'processName':
          return compare(a.processName, b.processName, isAsc);
        case 'timeLimit':
          return compare(a.timeLimit, b.timeLimit, isAsc);
        default:
          return 0;
      }
    });
